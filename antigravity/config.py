...
class Settings(BaseSettings):
    ...
    MAX_SINGLE_TRADE_LOSS: float = Field(30.0, gt=0, description="Max loss per single trade in USDT")
    ...
    STOP_LOSS_PCT: float = Field(0.015, description="Hard stop loss percentage")
    TRAILING_STOP_TRIGGER: float = Field(0.02, description="Trailing stop activation profit percentage")
